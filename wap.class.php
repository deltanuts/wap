...
class Wap {
    ...
    public $doCheckUser = false;
    public $user;
    public $modeResponse = 'template';
    public $tplBasePath = 'templates/';
    public $tplPath;
    public $tplIndex;
    //public $websitePath = '';
    public $modules;
    ...
    public function __construct(&$urlVars) {
        ...
        $this->pathWebSite = substr($_SERVER['SCRIPT_FILENAME'], 0, -9);
        $this->pathLib = $this->pathWebApp . 'libraries/';
        ...
        set_include_path(get_include_path() . PATH_SEPARATOR . $this->pathWebApp.'libraries'.PATH_SEPARATOR.$this->pathWebApp.'libraries/third');
        ...
        if ($this->getUrlVar('modeResp') <> '')
            $this->modeResponse = $this->getUrlVar('modeResp');
    }
    ...
    public function incComponentTpl() {
    ...
    public function execute() {
        if (isset($this->defaultArticle) && $this->defaultArticle != '')
    ...
    public function checkBrowser() {
        ...
        $browser = new Browser();
        $this->browserInfo['browser'] = $browser->getBrowser();
       $this->browserInfo['browserVersion'] = $browser->getVersion();
       $this->browserInfo['platform'] = $browser->getPlatform();
       $this->browserInfo['aolVersion'] = $browser->getAolVersion();
       $this->browserInfo['aol'] = $browser->isAol();
       $this->browserInfo['mobile'] = $browser->isMobile();
       $this->browserInfo['robot'] = $browser->isRobot();
       $this->browserInfo['userAgent'] = $browser->getUserAgent();
       $this->browserInfo['chromeFrame'] = $browser->isChromeFrame();
    }
    ...
    public function debugFile($message) {
        file_put_contents('/tmp/debugwebap.txt', $message . "\n");
    }
